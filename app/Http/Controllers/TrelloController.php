...
//    {
////        $body = 'newBoard';
////        return $this->request('POST', 'https://api.trello.com/1/boards?key=32335dc9a96db5455bb307490a60d207&token=24ceb7c8e7c3f8e9b32e4c25788359ea21db87a71c8ada27a23d7af890841c0a"', ['Authorization' => "Bearer $this->token", 'key' => $this->api_key, 'token' => $this->token], ['Authorization' => "Bearer $this->token", 'key' => $this->api_key, 'token' => $this->token]);
//        $headers = [
//            'Authorization' => 'Bearer ' . $this->token,
//            'key' => $this->api_key,
//            'name' => 'newB'
//        ];
//        $query_string = "key=$this->api_key&token=$this->token&name=newB";
